...
class IndentOneSpacePlugin(GObject.Object, Pluma.WindowActivatable):
    __gtype_name__ = "IndentOneSpacePlugin"
    ...
    def info(self):
        return {
            "Id": "IndentOneSpace",
            "Caption": "Indent One Space",
            "ShortCut": "<Alt>bracketright",
            "Hint": "Indents One Space",
